...
export function ProductsCard(props: StandardCardProps): JSX.Element {
  ...
  */
  ...
  const productName = Products.c_productCard.heading ? Products.c_productCard.heading : "Product Name";  // Description of the Products
  ...
  const productImage = Products.c_productCard
    ...
    : "#";
  const productBtn = Products.c_productCard.cta.label ? Products.c_productCard.cta.label: "Product cta"
    ...
    <>
      <div className={cssClasses.container}>
        ...
        <div>
          ...
          <p><a href={Products.c_productCard.cta.link}>{productBtn}</a></p>
        </div>
      </div>
    </>
  );
